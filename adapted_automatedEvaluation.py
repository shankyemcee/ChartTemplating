...
generatedPath = "./data/templatized_gold/field_infusing_system_summaries.json"
untemplatedPath = "./data/untemplatized_gold/GPT_gpt2_16.14.json"
baselinePath = 'data/generated_baseline/'
...
with open(generatedPath,encoding="utf8") as f:
            templated_summmaries = json.load(f)


with open(untemplatedPath,encoding="utf8") as f:
            untemplated_summmaries = json.load(f)

key_list=list(templated_summmaries.keys())
...
with open(labelPath, 'r', encoding='utf-8') as labelFile, open(summaryPath, 'r', encoding='utf-8') as summaryFile, \
    ...
    for lbls, summary, gold in zip(labelFile.readlines(), summaryFile.readlines(), goldFile.readlines()):
        ...
        summary1 = ''.join(templated_summmaries[key_list[count]])
        ...
        summary2 = ''.join(untemplated_summmaries[key_list[count]])
