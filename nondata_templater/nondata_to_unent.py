...
with open('trainOriginalSummary.txt', 'w',encoding="utf-8") as f:
...
with open('validOriginalSummary.txt', 'w',encoding="utf-8") as f:
    for item in templatedsummaryFile:
        f.write("%s\n" % item)
...
with open('testOriginalSummary.txt', 'w',encoding="utf-8") as f:
    for item in templatedsummaryFile:
        f.write("%s\n" % item)
